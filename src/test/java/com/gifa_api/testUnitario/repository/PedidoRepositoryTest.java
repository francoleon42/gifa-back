...
public class PedidoRepositoryTest {
    ...
    void setUp() {
        ...
        pedidoRepository.saveAll(List.of(pedido,pedido2,pedido3));
    }
    ...
    void testFindPedidosByTresEstados() {
        List<Pedido> pedidos = pedidoRepository.findPedidosByTresEstados(EstadoPedido.PENDIENTE,EstadoPedido.RECHAZADO
