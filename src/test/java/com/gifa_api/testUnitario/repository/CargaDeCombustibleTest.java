...
public class CargaDeCombustibleTest {
    ...
    void findByNumeroTarjetaAndFechaBetween() {
        ...
        CargaCombustible carga2 = CargaCombustible.builder()
                .cantidadLitros(60)
                .tarjeta(tarjeta)
                .fechaHora(OffsetDateTime.now().minusDays(1))
                .precioPorLitro(105f)
                .tarjeta(tarjeta)
                .build();
        ...
        List<CargaCombustible> resultados = cargaCombustibleRepository.findByNumeroTarjetaAndFechaBetween(tarjeta.getNumero()
                ,OffsetDateTime.now().minusDays(2),OffsetDateTime.now().plusDays(1));
    ...
    void testFindByNumeroTarjetaAndFechaAfterSinResultados() {
        ...
        List<CargaCombustible> resultados = cargaCombustibleRepository.findByNumeroTarjetaAndFechaBetween(tarjeta1.getNumero(), OffsetDateTime.now(),OffsetDateTime.now().plusDays(1));
